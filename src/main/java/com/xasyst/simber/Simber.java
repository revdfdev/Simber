...
public final class Simber {

    private static final Logger log = LoggerFactory.getLogger("Simber");
    ...
    public static abstract class Tree {
        ...
        public void i(Throwable t, String message, Object... args) {
            log.info(Marker.ANY_MARKER, message, args);
...
//            prepareLog(Log.WARN, null, message, args);
        ...
        public void e(Throwable t, String message, Object... args) {
            log.error(Marker.ANY_MARKER, message, t);
         ...
         *
         * @param priority Log level. See {@link} for constants.
